local home = vim.fn.expand("~\\kDrive2\\zettelkasten")
...
vim.cmd([[highlight tkLink ctermfg=magenta cterm=bold,underline guifg=magenta gui=bold,underline]])
-- hi tkBrackets ctermfg=gray guifg=gray

vim.cmd([[highlight tkBrackets ctermfg=DarkGray guifg=DarkGray]])
vim.cmd([[highlight tkTag ctermfg=214 guifg=#ffaf00]])
--C:\Users\user 
